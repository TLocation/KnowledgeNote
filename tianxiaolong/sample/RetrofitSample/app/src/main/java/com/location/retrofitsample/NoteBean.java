...
public class NoteBean {
	...
	public static class DataBean {
		...
		public static class DatasBean {
			 ...
			 * fresh : false
			 * id : 13996
			 * link : https://mp.weixin.qq.com/s/KkjwVVLWdSU9Uic9NKuGuw
			 * niceDate : 1天前
			 * niceShareDate : 1小时前
			 * origin :
			 * prefix :
			 * projectLink :
			 * publishTime : 1592668800000
			 * realSuperChapterId : 407
			 * selfVisible : 0
			 * shareDate : 1592829295000
			 * shareUser :
			 * superChapterId : 408
			 * superChapterName : 公众号
			 * tags : [{"name":"公众号","url":"/wxarticle/list/408/1"}]
			 * title : Android新技术了解：Jetpack Compose 更新，Preview2发布
			 * type : 0
			 * userId : -1
			 * visible : 1
			 * zan : 0
